...
const blogPosts = [
    {
        ...
        image: "/assets/assets/hero-bg.png",
        onclickImage: "/assets/assets/hero-bcg.jpeg",
...
const BlogHeader = () => {
    ...
    return (
        <div className="container flex ">
                <div className="flex flex-col py-6 md:grid grid-cols-2 lg:grid-cols-3 md:gap-10 xl:gap-8 2xl:grid-cols-4 gap-4 justify-center items-center w-full">
